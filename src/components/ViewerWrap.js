...
const ViewerWrap = (props) => {
    return (
        <div className="video relative cursor-pointer overflow-hidden rounded-xl border-[3px]  border-viewer-border pt-[55.25%] shadow-viewer transition-all duration-300 ease-viewer hover:scale-105 hover:shadow-viewer-hover video-hover:opacity-100">
            <img
